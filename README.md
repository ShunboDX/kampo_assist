...
* アプリの内容によっては「診断」「治療行為」とみなされ、薬機法の対象となる可能性がある

本サービスの前提と目的
本アプリは 診断や治療行為・処方決定を行うものではありません。
「症状・体質の入力に応じて、関連する漢方薬の候補を整理して提示する」
という 支援ツール に徹しています。
* 最終的な判断は必ず医療従事者が行う
...
## 本番環境URL
https://kampo-assist-1.onrender.com
...
一般的な薬は傷病に基づいて選択できますが、漢方は患者の症状から医師の経験や感覚的な判断に依存する部分が大きく、「どれを選ぶか」がブラックボックスになりがちです。判断基準を照らし合わせても候補が多岐にわたり、専門の先生でも迷ってしまうことがあると聞きました。
...
* 医師（一般内科・心療内科など、漢方も扱う医師）
  ...
  * 外来は非常に多忙で、1人の患者にじっくり漢方を検討する時間が限られており、まず候補を数種類まで絞ってくれるツールがあると意思決定がスムーズになるため。
